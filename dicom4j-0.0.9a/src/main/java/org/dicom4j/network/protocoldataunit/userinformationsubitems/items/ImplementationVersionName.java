 ...
 * 
 */
public class ImplementationVersionName extends AbstractUserInformationSubItem {

	private static Logger fLogger = LoggerFactory
	.getLogger(ImplementationVersionName.class);
	...
	public UserInformationSubItemType getType() {
		return UserInformationSubItemType.IMPLEMENTATION_VERSION_NAME;
	}
