 ...
 * 
 */
public class NSetRequest extends RequestedSOPClassUIDRequestMessage {

	public NSetRequest(int aMessageID, String aRequestedSOPClassUID)
	...
	public NSetRequest(int aMessageID, String aRequestedSOPClassUID,
		...
		this.setCommandField(CommandSetType.N_SET_REQUEST.value());
		this.setDataSetType(CommandSet.HAS_DATASET);
	}
	
	public CommandSetType getMessagetype() {
		return CommandSetType.N_SET_REQUEST;
	}
}
