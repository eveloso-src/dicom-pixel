...
public abstract class CompositeDimseResponseMessage extends DimseResponseMessage {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(CompositeDimseResponseMessage.class);
	
	public CompositeDimseResponseMessage(CommandSet commandSet) {
		super(commandSet);
	}

	public CompositeDimseResponseMessage(int messageID, String affectedSOPClassUID) throws DicomException {
		super(messageID);
