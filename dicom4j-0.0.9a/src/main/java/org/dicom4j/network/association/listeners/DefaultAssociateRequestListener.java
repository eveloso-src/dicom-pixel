...
/**
 * default implementation of {@link AssociateRequestHandler}
 * 
 * @deprecated use {@link DefaultAssociateRequestHandler} instead
 * @since 0.0.2
 * @author <a href="mailto:straahd@users.sourceforge.net">Laurent Lecomte
 */
@Deprecated
public class DefaultAssociateRequestListener implements AssociateRequestHandler {
	...
	public String toString() {
		return "DefaultAssociateRequestListener";
	}
