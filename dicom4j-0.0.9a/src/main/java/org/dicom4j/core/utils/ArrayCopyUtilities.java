...
abstract public class ArrayCopyUtilities {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/ArrayCopyUtilities.java,v 1.8 2004/01/24 13:56:18 dclunie Exp $";

	/**
	 * <p>
	 * Compare two double arrays and return true if both not null, and are of
	 * equal length and contain equal values.
	 * </p>
	 * 
	 * @param a1
	 * @param a2
	 ...
	 * 
	 * @param src
	 *          an array of int, whose values are interpreted as signed
	 ...
	 * 
	 * @param src
	 *          an array of short, whose values are interpreted as signed
	 ...
	 */
	static public String[] copyStringArrayRemovingLeadingAndTrailingPadding(
			String[] src) {
		if (src == null) {
			return null;
		}
		...
		for (int j = 0; j < n; ++j) {
			if (src[j] == null) {
				...
				int start = 0;
				while ((start < lng) && isLeadingPadding(src[j].charAt(start))) {
					++start;
				}
				int end = lng;
				while ((end > start) && isTrailingPadding(src[j].charAt(end - 1))) {
					--end;
				}
	 ...
	 * 
	 * @param src
	 *          an array of strings, each of which should be a decimal numeric
	 *          value
	 ...
	 * 
	 * @param src
	 *          an array of strings, each of which should be an integer numeric
	 *          value
	 * @return an array of int
	 */
	 ...
	 * 
	 * @param src
	 *          an array of strings, each of which should be an long numeric value
	 * @return an array of long
	 */
	 ...
	 * 
	 * @param src
	 *          an array of int, whose values are interpreted as unsigned
	 * @return an array of long
	 */
	static public long[] copyUnsignedIntToLongArray(int[] src) {
		...
		long[] dst = new long[n];
		for (int j = 0; j < n; ++j) {
			dst[j] = src[j] & 0xffffffff; // make sure of no sign extension
		}
		return dst;
	}
	 ...
	 * 
	 * @param src
	 *          an array of short, whose values are interpreted as unsigned
	 * @return an array of int
	 */
	...
	/**
	 * <p>
	 * Is this character a valid leading padding character in a DICOM string value
	 * ?
	 * </p>
	 * 
	 * @param c
	...
	/**
	 * <p>
	 * Is this character a valid trailing padding character in a DICOM string
	 * value ?
	 * </p>
	 * 
	 * @param c
