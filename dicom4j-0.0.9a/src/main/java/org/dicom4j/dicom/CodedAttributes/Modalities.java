 ...
 */
@Deprecated
public class Modalities extends CodedAttributes {
	...
	/*
	 * public static String toString(String aCode) { return
	 * Dicom4jImplementation.Instance().getModalities().getValue(aCode); }
	 */

	protected void addAttributes() {
		this.add(ComputedRadiography);
		this.add(ComputedTomography);
		this.add(IntraOralRadiography);
		this.add(Mammography);
		this.add(MagneticResonance);
		this.add(Other);
	}

	@Override
	public String toString() {
		return "dicom4j Modalities";
	}
